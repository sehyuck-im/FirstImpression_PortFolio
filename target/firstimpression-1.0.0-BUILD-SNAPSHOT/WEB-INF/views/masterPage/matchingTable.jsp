                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>${val.nickWhoLiked }</td>
                                            <td>${val.targetNick }</td>
                                            <td>
                                            <c:if test="${val.firstLike >1}">
                                            O
                                            </c:if>
                                            <c:if test="${val.firstLike <2}">
                                            X
                                            </c:if>
                                            </td>
                                            <td>
                                             <c:if test="${val.secondLike >1}">
                                            O
                                            </c:if>
                                            <c:if test="${val.secondLike <2}">
                                            X
                                            </c:if>
                                            </td>
                                            <td>
                                             <c:if test="${val.meetMade >1}">
                                            O
                                            </c:if>
                                            <c:if test="${val.meetMade <2}">
                                            X
                                            </c:if>
                                            </td>
                                            <td>${val.matchingdate }</td>
                                        </tr>
                                        </c:forEach>                                                                                   
                                    </tbody>
                                </table>
