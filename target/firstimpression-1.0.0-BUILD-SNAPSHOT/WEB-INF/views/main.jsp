			...
			<div class="row gx-4 gx-lg-5 justify-content-center mb-5">
				<div class="col-lg-6">
					<form id="signfrm" action="signUpForm.do" method="post">
						...
						<div class="d-grid mt-2" align="center">
							<a href="${url}" class="btn btn-naver"> <img
								height="60.383px" src="${path }/resources/design/btnNaver.png" /><span
								class="naverText" style="color: white;">네이버로 시작하기</span></a>
						</div>
					</form>
				</div>
			</div>
