		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="page-section">
					<div class="card mb-3">
						<h3 class="card-header">${profile.nick }</h3>
				...
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">My Preference</h4>
					</div>
					...
					<div class="card-footer text-muted">
						<a href="updatePreferenceForm.do" class="card-link">Preference
							수정</a>
					</div>
				</div>
			</div>
