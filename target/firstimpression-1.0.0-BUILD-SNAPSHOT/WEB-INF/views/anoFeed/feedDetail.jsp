			...
			function() {
				...
				$.ajax({
					...
					success : function(replyCount) {
						...
						$('#updateContent' + rpNum).val('');
						$('#updateCheck' + rpNum).prop("checked", false).attr(
			...
			function() {
				...
				$.ajax({
					...
					success : function(replyCount) {
						...
						$('#replyContent' + no).val('');
						$('#rpCheck' + no).prop("checked", false).attr(
								"checked", false).removeAttr("checked");
						location.reload();
						$('#replyCount' + no).html(
								'<span class="text-muted"> 댓글&nbsp;총'
										+ replyCount + '개 </span>');
					},
			...
			function() {
				...
				$.ajax({
					...
					success : function(replyCount) {
						...
						$('#replyContent' + ref).val('');
						$('#rpCheck' + ref).prop("checked", false).attr(
								"checked", false).removeAttr("checked");
						location.reload();
						$('#replyCount' + ref).html(
								'<span class="text-muted"> 댓글&nbsp;총'
