		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="page-section">
					...
					<th>
					<div class="card mb-3">
						<h3 class="card-header">${profile.nick }님과 매칭되었습니다.</h3>
					...
					<div class="card-footer">
						...
						<c:if test="${not empty profile.interest }">
							<c:forEach var="itList" items="${profile.interest }">
					...
					<div class="card">
						<div class="card-body">
							...
							<a href="deleteMatching.do?nick=${profile.nick }" class="card-link">별로에요</a> 
							<a href="addChating.do?nick=${profile.nick}" class="card-link">좋아요</a>
						</div>
					</div>
					</th>
					</tr>
