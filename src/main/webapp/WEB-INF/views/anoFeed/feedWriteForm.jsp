						...
						<fieldset>
							<div class="row">
								<span class="form-group col-lg-8"> <label
									...
									class="form-floating mb-3"> <input type="text"
										...
										placeholder="제목을 입력하세요" required="required"> <label
							...
							<div class="row">
								<span class="form-group col-lg-7"> <label for="formFile"
									...
									style="color: rgba(255, 255, 255, 0.7);"> 익명글🎭</label><input
							...
							<div class="accordion" id="accordionExample">
								<div class="accordion-item mt-3">
									...
									<div id="collapseOne" class="accordion-collapse collapse"
										...
										<input class="form-control" style="width:35%" type="text" id="filterText" placeholder="원하는 태그 검색">										
